...
global GENESIS_HASH
GENESIS_HASH = '00000d23fa0fc52c90893adb1181c9ddffb6c797a3e41864b9a23aa2f2981fe3'
...
class Storage(object):
    ...
    # convert between oracoin addresses and 20 bytes keys used for storage. 
    ...
    def listunspent(self, addr):
        key = self.address_to_key(addr)
        if key is None:
            raise BaseException('Invalid Oracoin address', addr)
    ...
    def write_undo_info(self, height, oracoind_height, undo_info):
        if height > oracoind_height - 100 or self.test_reorgs:
